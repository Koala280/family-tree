    ...
    <div className="circular-menu-overlay" onClick={handleOverlayClick}>
      <div className={`circular-menu ${isReady ? 'ready' : 'opening'}`}>
        ...
        <div className="circular-menu-items">
          <button className="circular-menu-item pos-up" onClick={handleItemClick(onAddParent)}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button className="circular-menu-item pos-up-right" onClick={handleItemClick(onLink)}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button className="circular-menu-item pos-right" onClick={handleItemClick(onAddSpouse)}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button className="circular-menu-item pos-down-right" onClick={handleItemClick(onUnlink)}>
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <button className="circular-menu-item pos-down" onClick={handleItemClick(onAddChild)}>
            <svg viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
            </svg>
          ...
          <button className="circular-menu-item danger pos-down-left" onClick={handleItemClick(onDelete)}>
            <svg viewBox="0 0 24 24" fill="currentColor">
