...
export const translations = {
  de: {
    ...
    potentialHereditaryRisksEmpty: 'Keine bekannten vererbten Risiken',
  ...
  lv: {
    ...
    filterBirthLabel: 'Dzimsana',
    filterDeathLabel: 'Nave',
    filterDateModeLabel: 'Rezims',
